...
class Evaluator {
  ...
  public static String evaluateQueryMetric5(
          String query, List<Integer> docids,
          Map<String, DocumentRelevances> judgments) {
    DocumentRelevances relevances = judgments.get(query);
  ...
  public static void evalRanker(
    ...
    try {
      ...
      String m0res = evaluateQueryMetric0(query, docids, judgments);
      String m1res = evaluateQueryMetric1(query, docids, judgments);
      String m2res = evaluateQueryMetric2(query, docids, judgments);
      String m3res = evaluateQueryMetric3(query, docids, judgments);
      String m4res = evaluateQueryMetric4(query, docids, judgments);
      ...
      String evalStr = query + m0res + m1res + m2res + m3res + m4res + m5res + m6res;
